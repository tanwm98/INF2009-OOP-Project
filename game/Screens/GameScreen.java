...
public class GameScreen implements Screen {
    ...
    private void setupGameEntities() {
        ...
        spaceship = new Spaceship("Objects/Spaceship/spaceship01.png",450,450,5, 5, camera,true,true);
        planet = new Planet("Objects/Planets/planet02.png",30, 10, 5, false,true);
        ...
        for(int i = 0; i < 5; i++) {
            ...
            asteroid = new Asteroid("Objects/Asteroid/asteroid01.png", posX, posY, -1, -1, true,true);
